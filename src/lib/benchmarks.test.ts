...
describe('benchmarkVerdict', () => {
  ...
  // Une division par zéro en amont produit NaN ou Infinity. Les deux sont traités
  // comme une absence de données, pas comme une mesure : `Infinity` €/km ne veut pas
  // dire « très au-dessus de la fourchette », ça veut dire que le kilométrage était
  // à zéro. Sans le garde-fou, NaN passerait toutes les comparaisons et retomberait
...
describe('formatRange', () => {
  ...
  it('formate les milliers avec séparateur', () => {
    // Espace insécable étroit selon la locale fr-FR : on teste la structure,
    // pas le caractère exact d'espacement.
