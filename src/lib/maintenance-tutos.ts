...
// Calqué sur repair-guides.ts (pièces) : difficulté, temps DIY indicatif, coût
// atelier indicatif et un lien vers un tuto public réputé. Liens Alltricks
// « surl » (redirections maintenues) — vérifiés en juillet 2026.
//
...
const TUTOS: Record<string, MaintenanceTuto> = {
  ...
  "nettoyage-transmission": {
    difficulty: "facile", timeMin: 20, timeMax: 40, laborMin: 20, laborMax: 35,
    tutorialUrl: "https://www.alltricks.fr/surl/entretien-transmission-velo",
    tutorialSource: "Alltricks",
  },
  "purge-freins": {
    difficulty: "expert", timeMin: 30, timeMax: 45, laborMin: 30, laborMax: 50,
    tutorialUrl: "https://www.alltricks.fr/surl/freinsadisquespurgersesfreins_v2",
    tutorialSource: "Alltricks",
  },
  "preventif-tubeless": {
    difficulty: "moyen", timeMin: 15, timeMax: 25, laborMin: 10, laborMax: 20,
    tutorialUrl: "https://www.alltricks.fr/surl/comment-passer-roue-en-tubeless",
    tutorialSource: "Alltricks",
  },
  "controle-serrages": {
    difficulty: "facile", timeMin: 10, timeMax: 20, laborMin: 15, laborMax: 25,
    tutorialUrl: "https://www.alltricks.fr/surl/verifications_v2",
    tutorialSource: "Alltricks",
  },
  "entretien-suspension": {
    difficulty: "expert", timeMin: 60, timeMax: 120, laborMin: 60, laborMax: 120,
    tutorialUrl: HUB_URL,
    tutorialSource: "Alltricks",
    shopOnly: true,
  },
  "revision-complete": {
    difficulty: "expert", timeMin: 0, timeMax: 0, laborMin: 60, laborMax: 120,
    tutorialUrl: HUB_URL,
    tutorialSource: "Alltricks",
    shopOnly: true,
  },
