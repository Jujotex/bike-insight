            ...
            {components.length === 0 ? (
              ...
              components.map((c) => {
                ...
                const installedDate = c.installed_at
                  ...
                  : "—";
                return (
                  <Link key={c.id} href={`/components/${c.id}`} style={{ textDecoration: "none", color: "inherit", display: "grid", gridTemplateColumns: "1.5fr 1fr 1.4fr 0.6fr 0.5fr 0.5fr", gap: 14, alignItems: "center", padding: "14px 22px", borderBottom: "1px solid var(--bi-line)", cursor: "pointer" }}
