        ...
        <Link href={`/reglages/entretiens/${type?.slug}/tuto?bike=${bikeId}`} style={{ display: "block", textDecoration: "none", color: "var(--bi-ink)" }}>
          ...
          <div style={{ padding: "18px 22px", background: urgent ? "var(--bi-accent)" : "var(--bi-accent-soft)", borderBottom: urgent ? "none" : "1px solid var(--bi-line)", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              <div style={{ width: 40, height: 40, borderRadius: 999, background: urgent ? "var(--bi-ink)" : "var(--bi-accent)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={urgent ? "var(--bi-accent)" : "var(--bi-accent-ink)"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>
              </div>
              <div>
            ...
            <div style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 13, fontWeight: 600, flexShrink: 0, color: urgent ? "var(--bi-white)" : "var(--bi-ink)", ...(urgent ? { background: "var(--bi-ink)", padding: "10px 16px", borderRadius: 999 } : {}) }}>
              Voir le tuto
